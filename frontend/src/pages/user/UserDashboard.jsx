  ...
  const actions = [
    {
      ...
      desc: "Find services for your event",
    ...
    {
      label: "Guest List",
      desc: "Manage event attendees",
      icon: <FiUsers size={20} />,
      path: "/user/guest-list",
      gradient: "from-emerald-500 to-green-600",
    },
    {
      label: `My Cart${cartItems.length > 0 ? ` (${cartItems.length})` : ""}`,
    ...
    <div className="animate-slide-up">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Plan your perfect event from here
        </p>
      </div>
      ...
      {cartItems.length > 0 && (
        <div className="bg-white rounded-2xl border border-gray-100 p-5 flex items-center gap-4 mb-6 shadow-sm">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-orange-500 text-white flex items-center justify-center shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {actions.map((a) => (
          ...
          >
            <div
              className={`w-12 h-12 rounded-xl bg-gradient-to-br ${a.gradient} flex items-center justify-center text-white shadow-sm`}
            >
              {a.icon}
            </div>
