      ...
      <div className="w-full max-w-[420px] animate-slide-up">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            {[
              { l: "Full Name", n: "name", t: "text", ph: "Enter your name" },
              { l: "Email", n: "email", t: "email", ph: "user@email.com" },
              {
                l: "Password",
                n: "password",
                t: "password",
              ...
              { l: "Phone", n: "phone", t: "text", ph: "Phone number" },
            ].map((f) => (
              <div key={f.n}>
                ...
                <input
                  ...
                  required
                  minLength={f.t === "password" ? 6 : undefined}
                  className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 focus:bg-white outline-none transition-all duration-200"
                  placeholder={f.ph}
                />
              </div>
            ))}
